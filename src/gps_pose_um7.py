...
class gps_pose_node(object):
	...
	def broadcast_transform(self):
		...
		self.t.child_frame_id = "scout"
		self.t.transform.translation.x = self.X
		self.t.transform.translation.y = self.Y
		self.t.transform.translation.z = 0.0

		q = tf_conversions.transformations.quaternion_from_euler(0, 0, self.to_2pi(self.HEADING)*(pi/180))
...
if __name__== '__main__':
	...
	with open(home_dir+"/boat_data/cont/CONT_LOG_"+str(dt)+".txt", 'w') as f:
